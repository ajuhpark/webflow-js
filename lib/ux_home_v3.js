...
function ux_home_v3() {
  ...
  function init() {
    ...
    // let tl_ux_home = gsap.timeline();
    // tl_ux_home.from("html", {
    //   duration: 0.2,
    //   autoAlpha: 0,
    //   ease: "power1.in"
    // });
    ...
    //     ".ux_home_v3_card_number_text",
    //     ".sc_1_card_text_header",
    //     ".sc_1_card_text_subheader", 
    //     ".sc_1_card_text_link_container_2",
    //     ".ux_home_v3_cs_card_image_wrapper",
    //     ".ux_home_v3_cs_card_image"
    //   ], {
    //     autoAlpha: 1,
    //     y: 0,
    //     x: 0,
    ...
    // mm.add("(min-width: 769px)", () => {
      ...
      banner_text_tl
        ...
        .slideUp(split_ux_nav_link_home.chars, {},
          "banner_text_tl_start+=0.3"
        )
        .slideUp(split_ux_nav_link_menu.chars, {}, "banner_text_tl_start+=0.4")
        
        .slideUp(split_sj_banner_4_header_text.chars, {}, "banner_text_tl_start+=0.5")
