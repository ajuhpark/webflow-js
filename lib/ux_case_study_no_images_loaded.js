...
function ux_case_study() {
  ...
  // Removed checkVideosLoaded - videos now have width/height attributes so space is reserved immediately
  ...
  function init() {
    ...
    // Start animations immediately - space is already reserved by width/height attributes
    document.fonts.ready.then(() => {
      console.log('✅ Fonts loaded');
      console.log('🎬 Starting animations immediately - space already reserved!');
      ...
      // Refresh ScrollTrigger after images load in background for perfect accuracy
      imagesLoaded(document.body, { background: true }, function() {
        console.log('✅ Images fully loaded - refreshing ScrollTrigger');
  ...
  function killAll() {
    ...
    gsap.delayedCall(0.1, () => {
      ...
      // Refresh ScrollTrigger after images fully load
      imagesLoaded(document.body, { background: true }, function() {
        console.log('✅ Images fully loaded - refreshing ScrollTrigger');
        ScrollTrigger.refresh();
      });
