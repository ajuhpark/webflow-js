...
function ux_home_v3() {
  ...
  function init() {
    ...
    // cs elements (first card - for banner timeline)
    let sc_1_card_text_header = document.querySelector(".sc_1_card_text_header");
    let ux_card_company_name_text = document.querySelector(".ux_card_company_name_text");
    let building_icon_svg = document.querySelector(".building_icon_svg");
    let sc_1_card_text_subheader = document.querySelector(".sc_1_card_text_subheader");
    let ux_btn_parent = document.querySelector(".ux_btn_parent");

    // SplitText for first card (banner timeline)
    ...
    let ux_home_v2_cs_card_video_wrapper = document.querySelector(".ux_home_v2_cs_card_image_wrapper.video");
    let ux_home_v2_cs_card_video = document.querySelector(".ux_home_cs_image_slot");
    ...
    banner_text_tl
      ...
      // first case study animations
      // .addLabel("first_cs_tl")
      .slideUp(split_sc_1_card_text_header.lines, {}, "banner_text_tl_start+=1")
      .slideUp(ux_card_company_name_text, {}, "banner_text_tl_start+=1.2")
      .slideUp(building_icon_svg, {}, "banner_text_tl_start+=1.2")
      .slideUp(split_sc_1_card_text_subheader.lines, {
        duration:0.8,
        stagger:0.3
      }, "banner_text_tl_start+=1.5")
      .slideUp(ux_btn_parent, {}, "banner_text_tl_start+=1.7")
      ...
      // Case studies loop with full animations (exclude #first_cs which has banner animations)
      let ap_grid_container_ux_home_cs = document.querySelectorAll(".ap_grid_container.ux_home_cs:not(#first_cs)");
