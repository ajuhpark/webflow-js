...
ScrollTrigger.normalizeScroll(true);  // Enable normalized scrolling
...
function init() {
  ...
  // Force a refresh on initialization to ensure proper positioning
...
window.addEventListener('load', function (event) {
  // If you add this into your page and wait for a few seconds do the triggers readjust to the correct place?
