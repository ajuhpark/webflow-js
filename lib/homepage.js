...
document.addEventListener('DOMContentLoaded', function() {
  console.log('DOM is ready - initializing animations');
  init();
});

// Also keep the load event as backup
...
window.addEventListener('load', function (event) {
  ...
  // ScrollTrigger.refresh(); // Force recalculations after everything loads
})

// window.addEventListener("resize", () => {
//   ScrollTrigger.refresh(); // Recalculate trigger positions on resize
// });
*/