...
function sct_text_decoration_svg() {
  ...
  function init() {
    ...
    const colors = {
      ...
      teal: 'var(--_theme---color_group_2--color-300)'
    };
    ...
    spanLines.forEach((spanLine, spanIndex) => {
      ...
      function positionLine() {
        ...
        const paddingY = 1; // vertical padding (adds space below each line)
    ...
    // === HIGHLIGHT TOP RIGHT - HIGHLIGHT_TOP_RIGHT.SVG ===
    ...
    spanUnderline3.forEach((spanUnderline, index) => {
      ...
      function positionUnderline() {
        ...
        // Adjust positioning to place underline below text
        const paddingY = 0; // vertical offset below text
    ...
    // === HIGHLIGHT TOP LEFT - HIGHLIGHT_05.SVG ===
    ...
    // === HIGHLIGHT TOP LEFT 1 - HIGHLIGHT_11.SVG ===
    ...
    // === HIGHLIGHT TOP RIGHT 2 - HIGHLIGHT_10.SVG ===
    ...
    // === HIGHLIGHT TOP RIGHT 3 - HIGHLIGHT_06.SVG===
    ...
    // === HIGHLIGHT ELLIPSE 07 (Original) - HIGHLIGHT_07.SVG===
    ...
    spanHighlightEllipse07_2.forEach((spanHighlight, index) => {
      ...
      svgHighlight.setAttribute('viewBox', '-22 -30 250 220');
      svgHighlight.setAttribute('preserveAspectRatio', 'none');
      svgHighlight.setAttribute('fill', 'none');
      svgHighlight.style.position = 'absolute';
      svgHighlight.style.pointerEvents = 'none';
