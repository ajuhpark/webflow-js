...
function ux_case_study() {
  ...
  function init() {
    ...
    document.fonts.ready.then(() => {
      ...
      checkVideosLoaded().then(() => {
        // Use imagesLoaded with callback to wait for all images
  ...
  function cs_intro_anim() {
    ...
    let tl_ux_cs_banner = gsap.timeline();
    animations.banner = tl_ux_cs_banner;
    ...
    originalContent.header = ux_cs_banner_company_name_text ? ux_cs_banner_company_name_text.innerHTML : '';
